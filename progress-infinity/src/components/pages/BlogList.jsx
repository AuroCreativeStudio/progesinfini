...
function BlogList() {
  ...
  {/* Image - moved up with negative margin and lower z-index */}
  ...
  {/* Links - with higher z-index to appear above image */}
    ...
    <ul className="text-base sm:text-lg font-medium text-black list-disc list-inside space-y-2 text-left">
      ...
      <li>Creative Corners</li>
        ...
        <div className="hidden lg:block">
          {/* Original header with side-by-side layout */}
        ...
        {/* Rest of the content (same for all screen sizes) */}
        ...
        <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-20 pb-12 lg:pb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 lg:gap-24">
            {blog.length === 0 ? (
              <p className="text-gray-600 col-span-3 text-center">No blogs available yet.</p>
            ) : (
              blog.map((post) => (
