        ...
        <table class="table table-bordered table-striped align-middle w-100">
            ...
            <tbody>
                @foreach($newsletters as $newsletter)
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="icon-btn delete-btn" 
                                    ...
                                    data-bs-target="#confirmModal{{ $newsletter->id }}"
                                    title="Delete">
                    ...
                    <div class="modal fade" id="confirmModal{{ $newsletter->id }}" tabindex="-1" aria-labelledby="confirmModalLabel{{ $newsletter->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                {{-- <div class="modal-header">
                                    <h5 class="modal-title" id="confirmModalLabel{{ $newsletter->id }}">Confirm Deletion</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div> --}}
                                <div class="modal-body text-center">
                                    <i class="fas fa-exclamation-triangle text-warning" style="font-size: 3rem;"></i>
                                    <p class="mb-0 mt-3">Are you sure you want to delete <strong>{{ $newsletter->email }}</strong>?<br>This action cannot be undone.</p>
                                </div>
