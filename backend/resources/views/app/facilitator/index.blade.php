        ...
        <table class="table table-bordered table-striped align-middle w-100">
            ...
            <tbody>
                @foreach($facilitators as $facilitator)
                        ...
                        <td>
                            <div class="d-flex gap-3 justify-content-center">
                                ...
                                <button class="action-btn delete-btn" 
                                        ...
                                        data-bs-target="#confirmModal{{ $facilitator->id }}"
                                        title="Delete">
                    ...
                    <div class="modal fade" id="confirmModal{{ $facilitator->id }}" tabindex="-1" aria-labelledby="confirmModalLabel{{ $facilitator->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                {{-- <div class="modal-header">
                                    <h5 class="modal-title" id="confirmModalLabel{{ $facilitator->id }}">Confirm Deletion</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div> --}}
                                <div class="modal-body text-center">
                                    <i class="fas fa-exclamation-triangle text-warning" style="font-size: 3rem;"></i>
                                    <p class="mb-0 mt-3">Are you sure you want to delete facilitator <strong>{{ $facilitator->name }}</strong>?<br>This action cannot be undone.</p>
                                </div>
